				...
				<div class="btn-group">
					...
					<ul class="dropdown-menu">
						<li>
							...
							<a href="#" rel="popover" data-content="A strikeout occurs when a batter receives three strikes during hit time at bat." data-original-title="Strikeout" class="
definition">K</a>
							...
							<a href="#" rel="popover" data-content="The number of games in which the player started the game in the starting lineup." data-original-title="Games Started" class="definition">GS</a>
						 	...
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of home runs." data-original-title="Home Run Rate" class="definition">HR Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of runs batted in." data-original-title="RBI Rate" class="definition">RBI Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of walks." data-original-title="Base on Balls Rate" class="definition">BB Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of strikeout." data-original-title="Strikeout Rate" class="definition">K Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of doubles hit." data-original-title="Double Rate" class="definition">Double Rate</a>
							<a href="#" rel="popover" data-content="The number of at bats divided by the number of triples hit." data-original-title="Triple Rate" class="definition">Triple Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of runs." data-original-title="Runs Rate" class="definition">Runs Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of stolen bases." data-original-title="Stolen Base Rate" class="definition">SB Rate</a>
						 	<a href="#" rel="popover" data-content="The number of at bats divided by the number of total bases." data-original-title="Total Bases Rate" class="definition">TB Rate</a>
						 	<a href="#" rel="popover" data-content="A player's stolen base percentage measures his rate of success in stealing bases. Formula: SB% = Stolen Bases/(Stolen Bases + Caught Stealing)" data-original-title="Stolen Base Percentage" class="definition">SB %</a>
						 	<a href="#" rel="popover" data-content='Runs created is a baseball statistic invented by Bill James to estimate the number of runs a hitter contributes to his team. The Baseball Engine uses the "Technical" version of runs created in its calculations.' data-original-title="Runs Created" class="definition">Runs Created</a>
						 	<a href="#" rel="popover" data-content="Measures how many of a batter's balls in play go for hits. Formula: BABIP = (Hits - Home runs)/(At Bats - Strikeouts - Home Runs + Sacrifice Flies)" data-original-title="Batting average on balls in play" class="definition">BABIP</a>
						 	<a href="#" rel="popover" data-content="Gross Production Average or GPA is a baseball statistic created in 2003 by Aaron Gleeman, as a refinement of On-Base Plus Slugging (OPS). Formula: GPA = ((1.8)OBP + SLG)/4" data-original-title="Gross Production Average" class="definition">GPA</a>
						 	<a href="#" rel="popover" data-content="A sabermetric which measures a batter's raw power. Formula: ISO = SLG - AVG." data-original-title="Isolated Power" class="definition">ISO</a>
						 <a href="#" rel="popover" data-content='Demonstrates how much a hitter contributes offensively to his team in comparison to a fictitious "replacement player," who is an average fielder at his position and a below average hitter.' data-original-title="Value over replacement player" class="definition">VORP</a>
						 	<a href="#" rel="popover" data-content="A measure of a hitter's plate discipline and knowledge of the strike zone." data-original-title="Walk-to-strikeout ratio" class="definition">BB:K</a>
						 	<a href="#" rel="popover" data-content="Normalizes league average so as to permit cross-era comparison. Formula: (Hits/At Bats)/((League Hits - Hits)/(League At Bats - At Bats))." data-original-title="Relative Batting Average" class="definition">Relative BA</a>
			...
			<div class="stat-select-Pitcher" style="display:none;">
              ...
              <a href="#" rel="popover" data-content="Games started indicates the number of games that a pitcher has started for his team." data-original-title="Games Started" class="definition">GS</a>
							...
							<a href="#" rel="popover" data-content="The percentage of the time a pitcher is awarded a win as opposed to a loss. Formula: Win % = Wins/(Wins + Losses)" data-original-title="Winning Percentage" class="definition">Win %</a>
							<a href="#" rel="popover" data-content="The number of innings pitched divided by the number strikeouts thrown." data-original-title="Strikeout Rate" class="definition">SO Rate</a>
						 	<a href="#" rel="popover" data-content="A statistic that measures a pitcher's ability to prevent hits during official at bats. Formula: BAA = Hits Allowed/(Batters Faced - Walks - Hit Batsmen - Sacrifice Hits - Sacrifice Flies)" data-original-title="Batting Average Against" class="definition">BAA</a>
						 	<a href="#" rel="popover" data-content="A measure of a pitcher's ability to control pitches." data-original-title="Strikeout-to-walk ratio" class="definition">SO/BB</a>
						 	<a href="#" rel="popover" data-content="Measures a pitcher's effectiveness based only on plays that do not involve fielders. Formula: FIP = ((13*Home Runs + 3*Walks - 2*Strikeouts)/(Innings Pitched))+3.1" data-original-title="Fielding Independed Pitching" class="definition">FIP</a>
						 	<a href="#" rel="popover" data-content="measure devised to quantify how many runs a pitcher saves for his team relative to a league average pitcher. Formula: PR = (League ERA - ERA)*((Innings Pitched/9))" data-original-title="Pitcher Runs" class="definition">PR</a>
						 	<a href="#" rel="popover" data-content="Intended to separate pitches who rely on their defense from those who don't. Formula: P/F Ration = (Strikeouts + Walks)/Innings Pitched." data-original-title="Power/Finesse Ratio" class="definition">P/F Ratio</a>
						 	<a href="#" rel="popover" data-content="CERA attempts to forecast a pitcher's earned run average from the number of hits and walks allowed rather than the standard formula of average number of earned runs per nine innings." data-original-title="Component ERA" class="definition">CERA</a>
						</li>
				</ul><!-- end dropdown-menu -->
				</div><!-- end btn-group -->
	...
	<div class="container-fluid gray" style="border-top:1px solid #EEE;margin:auto;">
		<span style="float:right;padding:10px;">&copy; <a href="/" target="_blank"></a>2012
 Baseball Engine | <a href="#contact" data-toggle="modal">Contact Me</a> | Last updated: <? echo date(' M j, y'); ?></span>
	</div>
...
<? if ($_SESSION["already_paid"]): ?>
<script type="text/javascript" src="/pro/js/paid.js"></script>
<? endif; ?>
<? if ($_SESSION["welcome"]): ?>
<script type="text/javascript" src="/pro/js/welcome.js"></script>
<? endif; ?>
